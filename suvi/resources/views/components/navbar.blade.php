<nav class="shadow-lg bg-white border-gray-200 fixed top-0 z-50 w-full">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                ...
                <ul
                    class="flex flex-col md:items-center  md:p-0 mt-4 font-medium    md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white   ">
                    <li class="">
                        {{-- <a href="#"
                            ...
                            aria-current="page"></a> --}}
                        <a href="" class="text-[#000]" aria-current="page">
                                Kelas
                            </a>
                    ...
                    <span class="hidden md:block text-white md:text-current">
                    ...
                    <li class="md:block rounded md:w-full md:bg-transparent ">
                        <div class="hidden md:block md:p-0  mb-0 pt-1.5 inline-block ">
                            <a href="{{ route('logout') }}"
                        ...
                        <div class="flex md:hidden items-center justify-between mb-[10px]">
                            <a class="text-[#BF5F00]" aria-current="page">
                                Profile
                            </a>
                            <span style="color: #a1a1aa;">
                                <i class="fa-xs	fa-solid fa-chevron-right"></i>
