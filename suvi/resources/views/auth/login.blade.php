...
@section('content')
    ...
    <div class="xl:mx-[30.5%] lg:mx-[20%] md:mx-[19%] sm:mx-[15%] mx-[10%]">
        ...
        <p class="text-[16px] font-[400] ops  mb-[35px]">If you dont have an account, you can <span
                class="text-[16px] font-[400] ops text-[#FF7E00] cursor-pointer">Sign Up Here</span> here ! !</p>

        <form method="POST" action="{{ route('login') }}">
            @csrf
            <label for="email" class="text-[13px] font-[400] ops" for="">Email</label>
            <div class="relative mt-[7px] mb-[38px]">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="17" viewBox="0 0 22 17"
                            ...
                            <defs>
                                <clipPath id="clip0_365_179">
                                    <rect width="21.0721" height="17" fill="white"
                                        transform="matrix(-1 0 0 1 21.072 0)" />
                                </clipPath>
                            </defs>
                        </svg>
                    </button>
                ...
                <input id="email" type="email"
                    class="@error('email') is-invalid @enderror placeholder-black form-input w-full form-control py-2 text-sm text-black bg-transparent text-[16px] font-[400] ops pl-10"
                    placeholder="Enter your email address" name="email" value="{{ old('email') }}" autocomplete="email"
                    autofocus>
            ...
            <label class="text-[13px] font-[400] ops" for="password">Password</label>
            <div class="relative mt-[7px] mb-[38px]">
                <span class="absolute inset-y-0 left-0 flex items-center">
                    <button type="submit" class="p-1 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="17" viewBox="0 0 22 17"
                ...
                <input id="password" name="password" type="password" required
                    class="@error('password') is-invalid @enderror placeholder-black form-input w-full form-control	py-2 text-sm text-black bg-transparent text-[16px] font-[400] ops pl-10 "
                    placeholder="Enter your Password" autocomplete="off">
            </div>

            <button type="form"
                class="mb-[13px] shadow-xl w-full text-center text-[17px] text-white font-[600] ops py-[12px]  bg-[#FF7E00] rounded-[32px]">
                Sign In
            </button>
        </form>
        ...
        <div class="flex justify-between px-[10px]">
            <button
                class="flex items-center border-[1.3px] border-[#525252] rounded-[5.25px] py-[13px] w-full items-center justify-start">
                <img class="ml-[10%] mr-[10%] sm:ml-[35px] sm:mr-[39px]" src="{{ asset('images/google.png') }}"
                    alt="">
            ...
            <button
                class="flex items-center border-[1.3px] border-[#525252] rounded-[5.25px] py-[13px] w-full items-center justify-start">
                <img class="ml-[10%] mr-[10%] sm:ml-[35px] sm:mr-[39px]" src="{{ asset('images/facebook.png') }}"
                    alt="">
